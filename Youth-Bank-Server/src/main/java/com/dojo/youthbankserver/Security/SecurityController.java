...
public class SecurityController {
    ...
    public Map<String, String> login(@RequestParam String email, @RequestParam String password) {
        // Authenticate user
        Authentication authentication = authenticationManager.authenticate(new EmailPasswordAuthenticationToken(email, password));
        ...
        String jwt = jwtEncoder.encode(jwtEncoderParameters);
