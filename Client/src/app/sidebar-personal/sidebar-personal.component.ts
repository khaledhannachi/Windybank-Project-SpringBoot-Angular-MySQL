...
@Component({
  selector: 'app-sidebar-personal',
  templateUrl: './sidebar-personal.component.html',
  styleUrls: ['./sidebar-personal.component.css']
})
export class SidebarPersonalComponent implements OnInit{
