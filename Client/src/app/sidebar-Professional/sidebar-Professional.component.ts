...
@Component({
  selector: 'app-sidebar-Professional',
  templateUrl: './sidebar-Professional.component.html',
  styleUrls: ['./sidebar-Professional.component.css']
})
export class SidebarProfessionalComponent implements OnInit{
