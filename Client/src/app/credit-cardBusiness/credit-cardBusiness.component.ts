...
@Component({
  selector: 'app-credit-cardPBusiness',
  templateUrl: './credit-cardBusiness.component.html',
  styleUrls: ['./credit-cardBusiness.component.css']
})
export class CreditCardBusinessComponent implements OnInit{
