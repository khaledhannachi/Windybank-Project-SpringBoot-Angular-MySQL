...
@Component({
  selector: 'app-credit-cardPSaving',
  templateUrl: './credit-cardSaving.component.html',
  styleUrls: ['./credit-cardSaving.component.css']
})
export class CreditCardSavingComponent implements OnInit{
