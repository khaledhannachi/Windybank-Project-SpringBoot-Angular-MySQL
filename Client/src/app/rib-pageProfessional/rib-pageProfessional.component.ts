...
@Component({
  selector: 'app-rib-pageProfessional',
  templateUrl: './rib-pageProfessional.component.html',
  styleUrls: ['./rib-pageProfessional.component.css']
})
export class RibPageProfessionalComponent implements  OnInit{
